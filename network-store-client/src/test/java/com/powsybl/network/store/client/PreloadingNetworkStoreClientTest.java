...
public class PreloadingNetworkStoreClientTest {
    ...
    public void setUp() throws IOException {
        ...
        cachedClient = new PreloadingNetworkStoreClient(new CachedNetworkStoreClient(new BufferedNetworkStoreClient(restStoreClient, ForkJoinPool.commonPool())),
            PreloadingStrategy.COLLECTION, ForkJoinPool.commonPool());
